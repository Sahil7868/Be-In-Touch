...
<center><h1 style="background-color:; color:#6495ED;"><b><i> Bus Insert<i><b></h1></center>
...
<form action="maininsertbus.php" enctype="multipart/form-data" method="post">
<div class="row" >
...
<div class="panel panel-info">
  ...
  <input type="text" class="form-control" placeholder="Enter Bus Name" aria-describedby="sizing-addon1" name="busname" required / >
</div>
  </td>
  </tr>
  <tr>
...
<div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon3" style="background-color:#4682B4; color:white;">Bus Num </span>
  <input type="text" class="form-control" placeholder="Enter Bus Num" aria-describedby="sizing-addon3" name="num" required />
</div>
  </td>
  </tr>
  ...
  <input type="number" class="form-control" placeholder="Enter Capacity" aria-describedby="sizing-addon1" name="capacity" required />
</div>
  </td>
  </tr>
  ...
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;"> Bus Details</span>
  <input type="textarea" class="form-control" placeholder="Enter Bus Details" aria-describedby="sizing-addon1" name="detail" required />
</div>
  </td>
  </tr>
  ...
  <select name="type" aria-describedby="sizing-addon1" style="width:300px;" required />
<?php 
...
<div class="input-group input-group-lg">
  ...
  <input type="file" class="form-control"  aria-describedby="sizing-addon3" name="photo" required />
</div>
  </td>
  </tr>
  ...
  <select name="driver_id" aria-describedby="sizing-addon1" style="width:300px;" required />
<?php 
