...
<h1 style="color:#6495ED;"><b><i>Facility Display Table<i><b></h1>
...
while($row=mysql_fetch_array($res,MYSQL_ASSOC))
{
		...
		echo '<td><a href="updatefacility.php?id='.$row["facility_id"].'"> <button style="background-color:white;"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button></a></td>';

echo '<td><a href="facilitydel.php?id='.$row["facility_id"].'"> <button style="background-color:white;"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></a></td>';
...
<a href="../project/insertpro.php"><input   type="button" name="add" value="Insert New Item"  style=" 
...
<a href="facilityinsert.php"><button style="background-color:white;"><span class="glyphicon glyphicon-plus" aria-hidden="true"></a>
</td>
</tr>
</div>
</div>
