...
<center><h1 style="background-color:; color:#6495ED;"><b><i>Update Slider Picture<i><b></h1><center>
...
$con=mysql_connect('localhost','root','');
mysql_select_db('bapa',$con);
$res=mysql_query("select * from slider_table where place_id='$id'",$con);
	while($row=mysql_fetch_array($res,MYSQL_ASSOC))
	{
...
<form action="placemainupdate.php?photo=<?php echo $photo; ?>" enctype="multipart/form-data" method="post">
<div class="row" >
...
<div class="panel panel-info">
  ...
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;">Place ID</span>
  ...
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;">Place Name</span>
  <input type="text" class="form-control" placeholder="Enter Car Name" aria-describedby="sizing-addon1"  name="placename" value="<?php echo $placename; ?>">
</div>
  </td>
  </tr>
  <tr>
...
<div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon3" style="background-color:#4682B4; color:white;">Place Image </span>
