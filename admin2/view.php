...
<center><h1 style="background-color:; color:#6495ED;"><b><i>View Your Profile<i><b></h1></center>
<br>
<br>
<br>
<br>
...
<div class="panel panel-info">
  <div class="panel-heading" style="background-color:#4682B4; ">
    <h3 class="panel-title" style=" color:white"><b>View Form</b></h3>
  </div>
 ...
 <table class="table">
  ...
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;">Mobile Num</span>
...
?>
  ...
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:4682B4;">City</span>
