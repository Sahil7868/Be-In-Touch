...
<h1 style="color:#6495ED;"><b><i>User Table<i><b></h1>
...
$con=mysql_connect('localhost','root','');
mysql_select_db('bapa',$con);
$res=mysql_query("select p.*,c.* from user_table as p , city as c where p.fk_city=c.city_id",$con);
...
<a href="userdel.php?id='.$row["email_id"].'"> <button style="background-color:white;"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></a></td>';
