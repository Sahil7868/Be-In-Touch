...
<center><h1 style="background-color:; color:#6495ED;"><b><i> Slider Picture Insert<i><b></h1></center>
...
<form action="maininsertplace.php" enctype="multipart/form-data" method="post">
<div class="row" >
...
<div class="panel panel-info">
  ...
  <input type="text" class="form-control" placeholder="Enter Place Name" aria-describedby="sizing-addon1" name="placename" required />
</div>
  </td>
  </tr>
