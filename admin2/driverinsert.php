...
<center><h1 style="background-color:; color:#6495ED;"><b><i> Driver Insert<i><b></h1></center>
...
<form action="maininsertdriver.php" enctype="multipart/form-data" method="post">
<div class="row" >
...
<div class="panel panel-info">
  ...
  <input type="text" class="form-control" placeholder="Enter Driver Name" aria-describedby="sizing-addon1" name="drivername" required/>
</div>
  </td>
  </tr>
  ...
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;">Driver Mobile_num</span>
  <input type="text" class="form-control" placeholder="Enter Driver Mobile num" aria-describedby="sizing-addon1" name="mobile" maxlength="10" required />
</div>
  </td>
  </tr>
