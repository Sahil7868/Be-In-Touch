...
<h1 style="color:#6495ED;"><b><i>City Display Table<i><b></h1>
...
while($row=mysql_fetch_array($res,MYSQL_ASSOC))
{
	...
	echo '<td><a href="updatecity.php?id='.$row["city_id"].'"> <button style="background-color:white;"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button></a></td>';

echo '<td><a href="citydel.php?id='.$row["city_id"].'"> <button style="background-color:white;"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></a></td>';
...
<a href="cityinsert.php"><button style="background-color:white;"><span class="glyphicon glyphicon-plus" aria-hidden="true"></a>
</td>
</tr>
</div>
</div>
