...
<center><h1 style="background-color:; color:#6495ED;"><b><i>Update Car<i><b></h1><center>
...
$con=mysql_connect('localhost','root','');
mysql_select_db('bapa',$con);
$res=mysql_query("select * from car_table where car_id='$id'",$con);
	while($row=mysql_fetch_array($res,MYSQL_ASSOC))
	{
		
		$id=$row['car_id'];
		$name=$row['car_name'];
		$photo=$row['car_image_1'];
		$de=$row['car_details'];
		$num=$row['car_num'];
		$cap=$row['capacity'];
		$fn=$row['fk_type_id'];
		$driver=$row['fk_driver_id'];
...
<form action="carmainupdate.php?photo=<?php echo $photo; ?>" enctype="multipart/form-data" method="post">
<div class="row" >
<div class="col-md-6 col-md-offset-3">

<div class="panel panel-info">
  <div class="panel-heading" style="background-color:#4682B4;">
    <h3 class="panel-title" style=" color:white"><b>Update Form</b></h3>
  </div>
  <table class="table">
    <tr>
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;">Car ID</span>
  <input type="text" class="form-control"  aria-describedby="sizing-addon1" name="txtid" value="<?php echo $id; ?>" readonly>
</div>
  </td>
  </tr>
  <tr>
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;">Car Name</span>
  <input type="text" class="form-control" placeholder="Enter Car Name" aria-describedby="sizing-addon1"  name="carname" value="<?php echo $name; ?>">
</div>
  </td>
  </tr>
  <tr>
...
<div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon3" style="background-color:#4682B4; color:white;">Car Image </span>
  <img height="100px" width="100px" src="<?php echo $photo;?>"/>
  <input type="file" class="form-control" aria-describedby="sizing-addon1" name="photo">
</div>
  </td>
  </tr>
  <tr>
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;"> Car Detail</span>
  <input type="text" class="form-control" placeholder="Enter Details" aria-describedby="sizing-addon1" name="detail" value="<?php echo $de; ?>">
</div>
  </td>
  </tr>
    <tr>
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;"> Car Num</span>
  <input type="text" class="form-control" placeholder="Enter Car Number" aria-describedby="sizing-addon1" name="no" value="<?php echo $num; ?>">
</div>
  </td>
  </tr>
    <tr>
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;"> Capacity</span>
  <input type="number" class="form-control" placeholder="Enter Capacity of car" aria-describedby="sizing-addon1" name="capu" value="<?php echo $cap; ?>">
</div>
  </td>
  </tr>
  ...
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;">Car Type</span>
		...
		<select name="type_id" style="width:300px;">
			<?php 
					...
					echo '<option '.$selected.'  value="'.$row["type_id"].'">'.$row["t_name"].'</option>';
					}
  ...
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;">Driver Name</span>
  
		
		<select name="driver_id" style="width:300px;">
			<?php 
					...
					{
						$selected="";
						if($driver==$row["driver_id"])
						{
							$selected="selected";
						}
						
					echo '<option '.$selected.'  value="'.$row["driver_id"].'">'.$row["name"].'</option>';
					}
  ...
  <center>
  <div class="btn-group" >
  <input type="submit" name="add" value="Update"   class="btn btn-warning " style="background-color:#4682B4; color:white; width:300px">
  </div>
  </td>
  </tr>
</table>
