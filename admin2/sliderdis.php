...
<h1 style="color:#6495ED;"><b><i>Slider Pictures Display Table<i><b></h1>
...
while($row=mysql_fetch_array($res,MYSQL_ASSOC))
{
		...
		echo "<td><img src='".$row['place_img']."' height='150px' width='150px'/></td>";
		...
		echo '<td> <a href="updateplace.php?id='.$row["place_id"].'"> <button style="background-color:white;"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button></a></td>';

echo '<td><a href="placedel.php?id='.$row["place_id"].'"> <button style="background-color:white;"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></a></td>';
...
<a href="placeinsert.php"><button style="background-color:white;"><span class="glyphicon glyphicon-plus" aria-hidden="true"></a>
</td>
</tr>
