...
<h1 style="color:#6495ED;"><b><i>Car Display Table<i><b></h1>
...
$con=mysql_connect('localhost','root','');
mysql_select_db('bapa',$con);
$res=mysql_query("select p.*,c.*,d.* from car_table as p , car_type_table as c, driver_table as d where p.fk_type_id=c.type_id and p.fk_driver_id=d.driver_id",$con);
...
while($row=mysql_fetch_array($res,MYSQL_ASSOC))
{
		...
		echo "<td><img src='".$row['car_image_1']."' height='50px' width='50px'/></td>";
		...
		echo '<td> <a href="updatecar.php?id='.$row["car_id"].'"> <button style="background-color:white;"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button></a></td>';

echo '<td><a href="cardel.php?id='.$row["car_id"].'"> <button style="background-color:white;"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></a></td>';
...
<a href="carinsert.php"><button style="background-color:white;"><span class="glyphicon glyphicon-plus" aria-hidden="true"></a>
</td>
</tr>
