...
?>
        ...
        <!-- end navbar side -->
        <!--  page-wrapper -->
        <div id="page-wrapper" style="background-color:white;">  <br>
<br>  
...
</center><h1 style="background-color:; color:#6495ED;"><b><i>Update Driver<i><b></h1></center>
...
$con=mysql_connect('localhost','root','');
mysql_select_db('bapa',$con);
$res=mysql_query("select * from driver_table where driver_id='$id'",$con);
	while($row=mysql_fetch_array($res,MYSQL_ASSOC))
	{
...
<form action="drivermainupdate.php" enctype="multipart/form-data" method="post">
<div class="row" >
...
<div class="panel panel-info">
  ...
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;">Driver ID</span>
  ...
  <input type="text" class="form-control" placeholder="Enter Driver Name" aria-describedby="sizing-addon1"  name="busname" value="<?php echo $name; ?>">
</div>
  </td>
  </tr>
  <tr>
...
<div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon3" style="background-color:#4682B4; color:white;">Mobile Number </span>
  <input type="text" class="form-control" placeholder="Enter Mobile Number" aria-describedby="sizing-addon3" name="mobile" maxlength="10" value="<?php echo $mob; ?>">
</div>
  </td>
  </tr>
  ...
  <center>
  <div class="btn-group" >
  <input type="submit" name="btninsert" value="Update" class="btn btn-warning " style="background-color:#4682B4; color:white; width:300px">
  </div>
</table>
</form>
