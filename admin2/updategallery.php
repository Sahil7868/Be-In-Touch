...
<center><h1 style="background-color:; color:#6495ED;"><b><i>Update Picture<i><b></h1><center>
...
<?php
	$id=$_REQUEST["id"];
				...
				$res=$obj->getdata("select * from gallery_table where pic_id='$id'");
...
<form action="gallerymainupdate.php?photo2=<?php echo $photo2; ?>" enctype="multipart/form-data" method="post">
<div class="row" >
...
<div class="panel panel-info">
  ...
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;">ID</span>
...
<div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon3" style="background-color:#4682B4; color:white;"> Image 1</span>
  <img height="100px" width="100px" src="<?php echo $photo1;?>"/>
  <input type="file" class="form-control" aria-describedby="sizing-addon1" name="photo1">
</div>
  </td>
  </tr>
...
<div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon3" style="background-color:#4682B4; color:white;"> Image 2</span>
  <img height="100px" width="100px" src="<?php echo $photo2;?>"/>
  <input type="file" class="form-control" aria-describedby="sizing-addon1" name="photo2">
</div>
  </td>
  </tr>
...
<div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon3" style="background-color:#4682B4; color:white;"> Image 3</span>
  <img height="100px" width="100px" src="<?php echo $photo3;?>"/>
  <input type="file" class="form-control" aria-describedby="sizing-addon1" name="photo3">
</div>
  </td>
  </tr>
