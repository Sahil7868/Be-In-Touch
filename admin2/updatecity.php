...
</center><h1 style="background-color:; color:#6495ED;"><b><i>Update City<i><b></h1></center>
...
$con=mysql_connect('localhost','root','');
mysql_select_db('bapa',$con);
$res=mysql_query("select * from city where city_id='$id'",$con);
	while($row=mysql_fetch_array($res,MYSQL_ASSOC))
	{
...
<form action="citymainupdate.php" enctype="multipart/form-data" method="post">
<div class="row" >
<div class="col-md-6 col-md-offset-3">

<div class="panel panel-info">
  <div class="panel-heading" style="background-color:#4682B4;">
    <h3 class="panel-title" style=" color:white"><b> Update City</b></h3>
  </div>
  <table class="table">
    <tr>
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;">City ID</span>
  ...
  <input type="text" class="form-control" placeholder="Enter City Name" aria-describedby="sizing-addon1"  name="busname" value="<?php echo $name; ?>">
</div>
  </td>
  </tr>
