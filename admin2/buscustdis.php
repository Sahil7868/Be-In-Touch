...
<h1 style="color:#6495ED;"><b><i>Bus Customer Table<i><b></h1>
	<table   class="table table-striped" id="dataTable" style="color:black" width="650px;" height="200px">
<thead>
<tr>
<th>Email Id</th>
<th>Mobile Num</th>
...
$con=mysql_connect('localhost','root','');
mysql_select_db('bapa',$con);
$res=mysql_query("select * from bus_customer_tbl",$con);
...
while($row=mysql_fetch_array($res,MYSQL_ASSOC))
{
		...
		echo '<td ><a href="updatebuscust.php?id='.$row["cust_id"].'"> <button style="background-color:white;"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button></a></td>';
		

echo '<td ><a href="buscustdel.php?id='.$row["cust_id"].'"> <button style="background-color:white;"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></a></td>';
echo '<td ><a href="reminder1.php?id='.$row["cust_id"].'"> <button style="background-color:white;"><span class="glyphicon glyphicon-send" aria-hidden="true"></span></button></a></td>';
