...
<h1 style="color:#6495ED;"><b><i>Feedback Display Table<i><b></h1>
...
$con=mysql_connect('localhost','root','');
mysql_select_db('bapa',$con);
$res=mysql_query("select * from feedback_table",$con);
...
<a href="feeddel.php?id='.$row["f_id"].'"> <button style="background-color:white;"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></a></td>';
