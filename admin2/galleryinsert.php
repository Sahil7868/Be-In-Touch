...
<center><h1 style="background-color:; color:#6495ED;"><b><i> Picture Insert<i><b></h1></center>
...
<form action="maininsertgallery.php" enctype="multipart/form-data" method="post">
<div class="row" >
...
<div class="input-group input-group-lg">
  ...
  <input type="file" class="form-control"  aria-describedby="sizing-addon3" name="photo1" >
</div>
  </td>
  </tr>
...
<div class="input-group input-group-lg">
  ...
  <input type="file" class="form-control"  aria-describedby="sizing-addon3" name="photo2" >
</div>
  </td>
  </tr>
...
<div class="input-group input-group-lg">
  ...
  <input type="file" class="form-control"  aria-describedby="sizing-addon3" name="photo3" >
</div>
  </td>
  </tr>
