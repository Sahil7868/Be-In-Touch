...
<center><h1 style="background-color:; color:#6495ED;"><b><i>Edit Your Profile<i><b></h1></center>
<br>
<br>
<br>
<br>
...
<form action="updateprofile.php" enctype="multipart/form-data" method="post" name="form1">
 <div class="row" >
<div class="col-md-6 col-md-offset-3">

<div class="panel panel-info">
  <div class="panel-heading" style="background-color:#4682B4; ">
    <h3 class="panel-title" style=" color:white"><b>Edit Form</b></h3>
  </div>
 ...
 <table class="table">
  ...
  <input type="text" class="form-control" placeholder="Enter User name" aria-describedby="sizing-addon1" name="username" onblur="return userid_validation(document.form1.username,5,12);" value="<?php echo $username; ?>" required />
</div>
  </td>
  </tr>
  ...
  <input type="number" class="form-control" placeholder="Enter Mobile Number" aria-describedby="sizing-addon1" name="mob" maxlength="10" onkeypress='return event.charCode >= 48 && event.charCode <= 57' value="<?php echo $mobile; ?>" required />
</div>
  </td>
  </tr>
 ...
 <tr>
  <td>
    <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;">Display Picture</span>
   <br>
 

    
	<img src="<?php echo $photo;?>"  height="200px" width="200px" >
...
<center> 
<div class="btn-group">
<input  type="submit" name="edit" style="background-color:#4682B4; width:300px; color:white;" value="Edit">
</div>
</td>
</tr>
