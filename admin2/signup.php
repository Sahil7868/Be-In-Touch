...
<center><h1 style="background-color:; color:#6495ED;"><b><i>Add Another Admin</i></b></h1></center>
<br>
<br>
<?php 
if(isset($_POST["add"]))
				...
				else
			{
							...
							if($cnfpassword==$password)
						{
										...
										if($ext=="jpg" ||$ext=="png" ||$ext=="jpeg")
									{
												...
												$con=mysql_connect('localhost','root','');
												mysql_select_db('bapa',$con);
												$res=mysql_query("insert into user_table values('$email','$username','$mob','$gender','$city','$password','$str','$type','$date','viewed')",$con);
												if ($res==1)
											{
												...
												else
											{
													...
													echo"<center><h2><b>Something wrong entered</b></h2></center>";
											}	
									}
										else
									{
...
<div class="panel panel-info">
  <div class="panel-heading" style="background-color:#4682B4; ">
    <h3 class="panel-title" style=" color:white"><b>Add Admin</b></h3>
  </div>		
 <table class="table">
  <tr>
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;">User Name</span>
 ...
 <tr>
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" for="exampleInputEmail1" style="background-color:#4682B4; color:white;">Email address</span>
 ...
 <tr>
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;">Password</span>
 ...
 <tr>
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;">Confirm Password</span>
 ...
 <tr>
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;">Mobile Number</span>
  <input type="text" class="form-control" placeholder="Enter Mobile Number" aria-describedby="sizing-addon1" name="mobile" maxlength="10" onkeypress='return event.charCode >= 48 && event.charCode <= 57' onblur="return allnumeric(document.form1.txt_mob);" required />
</div>
  </td>
  </tr>
  ...
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;">City </span>
...
?>
  ...
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;">Gender</span>
 ...
 <tr>
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;">Profile Photo</span>
...
<center> 
<div class="btn-group">
<input  type="submit" name="add" class="btn btn-warning" style="background-color:#4682B4; color:white; width:300px;" value="sign in" >
</div>
</td>
</tr>
 </table>
