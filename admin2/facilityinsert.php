...
<center><h1 style="background-color:; color:#6495ED;"><b><i>Facility Insert<i><b></h1><center>
...
<form action="maininsertfacility.php" enctype="multipart/form-data" method="post">
<div class="row" >
...
<div class="panel panel-info">
  ...
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;"><b>Facility Name</b></span>
  <input type="text" class="form-control" placeholder="Enter Facilities" aria-describedby="sizing-addon1" name="carname" required />
</div>
  </td>
  </tr>
