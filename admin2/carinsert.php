...
<center><h1 style="background-color:; color:#6495ED;"><b><i> Car Insert<i><b></h1></center>
...
<form action="maininsertcar.php" enctype="multipart/form-data" method="post">
<div class="row" >
...
<div class="panel panel-info">
  ...
  <input type="text" class="form-control" placeholder="Enter Car Name" aria-describedby="sizing-addon1" name="carname" required />
</div>
  </td>
  </tr>
  <tr>
...
<div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon3" style="background-color:#4682B4; color:white;">Car Num </span>
  <input type="text" class="form-control" placeholder="Enter Car Num" aria-describedby="sizing-addon3" name="h" required />
</div>
  </td>
  </tr>
  ...
  <input type="number" class="form-control" placeholder="Enter Capacity" aria-describedby="sizing-addon1" name="c" required />
</div>
  </td>
  </tr>
  ...
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;"> Car Details</span>
  <input type="text" class="form-control" placeholder="Enter Car Details" aria-describedby="sizing-addon1" name="deatail" required />
</div>
  </td>
  </tr>
  ...
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;"> Car Model </span>
...
$res=mysql_query("select * from car_type_table",$con);
 while($row=mysql_fetch_array($res,MYSQL_ASSOC))
 {
	...
	echo '"<option value="'.$row["type_id"].'">'.$row["t_name"].'</option>"';
