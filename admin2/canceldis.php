...
<h1 style="color:#6495ED;"><b><i>Cancel Display Table<i><b></h1>
...
<a href="canceldel.php?id='.$row["cancel_id"].'"> <button style="background-color:white;"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></a></td>';
