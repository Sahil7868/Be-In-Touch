...
<h1 style="color:#6495ED;"><b><i>Car Model Table<i><b></h1>
...
while($row=mysql_fetch_array($res,MYSQL_ASSOC))
{
		...
		echo '<td><a href="updatecartype.php?id='.$row["type_id"].'"> <button style="background-color:white;"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button></a></td>';

echo '<td><a href="cartypedel.php?id='.$row["type_id"].'"> <button style="background-color:white;"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></a></td>';
...
<tr>
<td align="center">
<a href="cartypeinsert.php"><button style="background-color:white;"><span class="glyphicon glyphicon-plus" aria-hidden="true"></a>
</td>
</tr>
</table>
</div>
