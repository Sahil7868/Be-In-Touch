...
<center><h1 style="background-color:; color:#6495ED;"><b><i> Car Model Insert<i><b></h1></center>
...
<form action="maininsertcartype.php" enctype="multipart/form-data" method="post">
<div class="row" >
...
<div class="panel panel-info">
  ...
  <input type="text" class="form-control" placeholder="Enter Car Type" aria-describedby="sizing-addon1" name="carname" required />
</div>
  </td>
  </tr>
