...
<h1 style="color:#6495ED;"><b><i>Gallery Display Table<i><b></h1>
...
<?php 
				...
				$res=$obj->getdata("select * from gallery_table");

while($row=mysql_fetch_array($res,MYSQL_ASSOC))
{
		echo "<tr>";
		
		echo "<td><img src='".$row['pic1']."' height='100px' width='100px'/></td>";
		echo "<td><img src='".$row['pic2']."' height='100px' width='100px'/></td>";
		echo "<td><img src='".$row['pic3']."' height='100px' width='100px'/></td>";
		...
		echo '<td> <a href="updategallery.php?id='.$row["pic_id"].'"> <button style="background-color:white;"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button></a></td>';

echo '<td> <a href="gallerydel.php?id='.$row["pic_id"].'"> <button style="background-color:white;"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></a></td>';
...
<a href="galleryinsert.php"><button style="background-color:white;"><span class="glyphicon glyphicon-plus" aria-hidden="true"></a>
</td>
</tr>
