...
while($row=mysql_fetch_array($res,MYSQL_ASSOC))
{
		...
		echo '<td ><a href="updatebus.php?id='.$row["bus_id"].'"> <button style="background-color:white;"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button></a></td>';

echo '<td ><a href="busdel.php?id='.$row["bus_id"].'"> <button style="background-color:white;"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></a></td>';
