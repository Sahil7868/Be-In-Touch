...
<center><h1 style="background-color:; color:#6495ED;"><b><i>Update Facility<i><b></h1></center>
...
$con=mysql_connect('localhost','root','');
mysql_select_db('bapa',$con);
$res=mysql_query("select * from facility_table where facility_id='$id'",$con);
	while($row=mysql_fetch_array($res,MYSQL_ASSOC))
	{
...
<form action="facilitymainupdate.php" enctype="multipart/form-data" method="post">
<div class="row" >
...
<div class="panel panel-info">
  ...
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;"> Facility Id</span>
  ...
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;"> Amenities</span>
  <input type="text" class="form-control" placeholder="Enter Amenity" aria-describedby="sizing-addon1"  name="busname" value="<?php echo $name; ?>">
</div>
  </td>
  </tr>
