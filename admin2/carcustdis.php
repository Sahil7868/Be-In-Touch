...
<h1 style="color:#6495ED;"><b><i>Car Customer Table<i><b></h1>
	<table   class="table table-striped" id="dataTable" style="color:black; font-size: small; " >
<thead>
<tr>
<th>Email</th>
<th>Car Name</th>
...
$con=mysql_connect('localhost','root','');
mysql_select_db('bapa',$con);
$res=mysql_query("select p.*,c.* from car_customer_table as p , car_table as c where p.fk_car_id=c.car_id",$con);
...
while($row=mysql_fetch_array($res,MYSQL_ASSOC))
{
		...
		echo "<td><img src='".$row['license_image']."' height='50px' width='50px'/></td>";
		echo "<td>".$row['with_driver']."</td> ";
		
		echo "<td>".$row['statused']."</td> ";
		echo "<td>".$row['starting_km']."</td> ";
		echo "<td>".$row['ending_km']."</td>";
	...
	echo '<td><a href="updatecarcust.php?id='.$row["cust_id"].'"> <button style="background-color:white;"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button></a></td>';

echo '<td><a href="carcustdel.php?id='.$row["cust_id"].'"> <button style="background-color:white;"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></a></td>';
echo '<td><a href="reminder.php?id='.$row["cust_id"].'"> <button style="background-color:white;"><span class="glyphicon glyphicon-send" aria-hidden="true"></span></button></a></td>';
