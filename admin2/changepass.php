...
<center><h1 style="background-color:; color:#6495ED;"><b><i>Change Password</i></b></h1></center>
<br>
<br>
<?php
...
<div class="panel panel-info">
  <div class="panel-heading" style="background-color:#4682B4; ">
    <h3 class="panel-title" style=" color:white"><b>Change Password</b></h3>
  </div>
 ...
 <table class="table">
  ...
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;">Old Password</span>
...
<tr>
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;">New Password</span>
...
<center> 
<div class="btn-group">
<input  type="submit" name="change" class="btn btn-warning" style="background-color:#4682B4; width:300px; color:white;" value="change">
</div>
</td>
</tr>
