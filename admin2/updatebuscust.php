...
<center><h1 style="background-color:; color:#6495ED;"><b><i>Update Kilometers<i><b></h1></center>
<br>
<br>
<br>
<br>
...
$con=mysql_connect('localhost','root','');
mysql_select_db('bapa',$con);
$res=mysql_query("select * from bus_customer_tbl where cust_id='$id'",$con);
	while($row=mysql_fetch_array($res,MYSQL_ASSOC))
	{
		
		$id=$row['cust_id'];
		$s_km=$row['starting_km'];
		$e_km=$row['ending_km'];
...
<form action="buscustmainupdate.php" enctype="multipart/form-data" method="post">
<div class="row" >
...
<div class="panel panel-info">
  ...
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;">Starting Km</span>
  <input type="text" class="form-control" placeholder="Enter starting km" aria-describedby="sizing-addon1"  name="starting_km" value="<?php echo $s_km; ?>">
</div>
  </td>
  </tr>
  ...
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background-color:#4682B4; color:white;">Ending Km</span>
  <input type="text" class="form-control" placeholder="Enter Ending km" aria-describedby="sizing-addon1"  name="ending_km" value="<?php echo $e_km; ?>">
</div>
  </td>
  </tr>
