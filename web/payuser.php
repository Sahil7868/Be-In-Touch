...
<nav class="navbar navbar-inverse" style="background:#F8F8FF; border-color:#2F4F4F; border-width:2px;">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
	  ...
	  <a  class="navbar-brand" href="payuser.php" style="color:black;" >Via Credit Card</a>
	  <a  class="navbar-brand" href="" style="color:black;" >||</a>
      <a class="navbar-brand" href="payuser1.php" style="color:black;"> Via Debit Card  </a>
    </div>
...
<div class="col-md-2">
 ...
 <form action="payinsert.php" enctype="multipart/form-data" method="post">
