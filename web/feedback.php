...
<div class="container">
 ...
 <h1 style="background-color:; color:#2F4F4F;"><b><i>Feedback</i></b></h1>
...
<form action="feedinsert.php" enctype="multipart/form-data" method="post">
<div class="row" >


<div class="panel panel-info">
  <div class="panel-heading" style="background:#2F4F4F">
   <h3 class="panel-title" style=" color:white">Form</h3>
  </div>
  <table class="table">
  ...
  <span class="input-group-addon" id="sizing-addon1" style="background:#2F4F4F; color:white">Email Id</span>
  <input type="text" class="form-control"  aria-describedby="sizing-addon1" name="id" value="<?php echo $email; ?>" readonly>
</div>
  </td>
  </tr>
    <tr>
  ...
  <input type="text" class="form-control"  aria-describedby="sizing-addon1" name="uname" value="<?php echo $name; ?>" readonly>
</div>
  </td>
  </tr>
  <tr>
  ...
  <input type="number" class="form-control"  aria-describedby="sizing-addon1"  name="mob" value="<?php echo $mob; ?>" readonly>
</div>
  </td>
  </tr>
  <tr>
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background:#2F4F4F; color:white">Description</span>
  <input type="text" class="form-control" placeholder="Enter Description" aria-describedby="sizing-addon1"  name="des" required />
</div>
  </td>
  </tr>
  ...
  <center>
  <div class="btn-group" >
  <input type="submit" name="add" value="Done"  style="background:#2F4F4F; color:white; width:500px; height:40px;">
  </div>
  </td>
  </tr>
</table>
