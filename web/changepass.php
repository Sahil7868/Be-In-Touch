...
<div class="container">
<h1 style="background-color:; color:#2F4F4F;"><b><i> Change Your Password Here <i><b></h1>
...
$obj=new database();
$res=$obj->getdata("select * from user_table where email_id='$email'");
...
if($pass1==$old)
{
	...
	if($newpass==$confirm)
	{
		$res=$obj->getdata("update user_table set password='$newpass' where email_id='$email'");
		Header("Location:user.php");
	}
	else
	{
		echo "check ur new password";
	}
}
	else
	{
...
<nav class="navbar navbar-inverse" style="background:#F8F8FF; border-color:#2F4F4F; border-width:2px;">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
	  ...
	  <a  class="navbar-brand" href="view.php" style="color:black;" >View Your Profile</a>
...
<h3 class="panel-heading" style="color:white"><center>Change Your Password </center></h3>
 ...
 <table class="table">
  ...
  <span class="input-group-addon" id="sizing-addon1" style="background:#2F4F4F; color:white">Old Password</span>
  <input type="password" class="form-control" placeholder="Enter Old Password" aria-describedby="sizing-addon1" name="old" required />
</div>
  </td>
  </tr>
...
<tr>
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background:#2F4F4F;color:white">New Password</span>
  <input type="password" class="form-control" placeholder="Enter New Password" aria-describedby="sizing-addon1" name="new" onblur="return passid_validation(document.form1.password,5,12);"  required />
</div>
  </td>
  </tr>
 ...
 <tr>
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background:#2F4F4F;color:white">Confirm Password</span>
  <input type="password" class="form-control" placeholder="Enter Confirm Password" aria-describedby="sizing-addon1" name="confirm" onblur="return passid_validation(document.form1.password,5,12);"  required />
</div>
  </td>
  </tr>
...
<center> 
<div class="btn-group">
<input  type="submit" name="change" style="background:#2F4F4F; width:300px;color:white" value="change">
</div>
</td>
</tr>
