...
<form action="custinsert.php" enctype="multipart/form-data" method="post">
<div class="row" >
...
<div class="panel panel-info">
  ...
  <span class="input-group-addon" id="sizing-addon1" style="background:#2F4F4F; color:white">Car Name</span>
  ...
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background:#2F4F4F; color:white">Car Number</span>
  ...
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background:#2F4F4F; color:white">With Driver</span>
  <input type="radio" name="php1" value="Yes" style="width:100px;">Yes</br>
  <input type="radio" name="php1" value="No" style="width:100px;">No</br>
</div>
  </td>
  </tr>
  ...
  <input type="date" class="form-control" aria-describedby="sizing-addon1"  name="dd" required />
</div>
  </td>
  </tr>
...
<div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon3" style="background:#2F4F4F; color:white">License image</span>
  ...
  <td>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" style="background:#2F4F4F; color:white">Another Address</span>
