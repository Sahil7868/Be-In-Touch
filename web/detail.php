...
<body>
	...
	<div class="banner" id="home">
		...
		<div class="container">
			 <h1 style="background-color:; color:#2F4F4F;"><b><i>Your Choiced Cars Details<i><b></h1>
...
while($row=mysql_fetch_assoc($res))
{
	...
	echo'</div>';
	echo'</a>';
   //  echo  '<p><a href="detail.php?id='.$row["car_id"].'" class="btn btn-success"  style="background-color:#2F4F4F; color:white;" role="button">Book</a></p>';  
     echo'</div>';  
         echo' <div class="caption">';
		//echo' <b> Car Name </b>';
		echo'<h3><b>Car Name:-<b>'.$row["car_name"].'</h3>';
		echo'</br>';
		echo'<h3><b>Car Model:-<b>'.$row["fk_type_id"].'</h3>';
		echo'</br>';
		echo' <h3><b>Car Details:-<b>'.$row["car_details"].'</h3>';
		echo'</br>';
		echo' <h3><b>Car Capacity:-<b>'.$row["capacity"].'</h3>';
		//echo'</br>';
...
while($row=mysql_fetch_assoc($res))
{
	 ...
	 echo  '<p><a href="carcustdetail.php?id='.$row["car_id"].'" class="btn btn-success"  onclick="return checkdelete()" style="background-color:#2F4F4F; color:white; width:400px; height:30px;" role="button">Book</a></p>';  
