...
function carousel() {
	...
	<br>
	<br>
	 <h1 style="background-color:; color:#2F4F4F;"><b><i>Your Booked Buses</i></b></h1>
	 <br>
...
$res=mysql_query("select * from bus_customer_tbl where fk_email_id='$email1' and status='booked'",$con);
...
<a href="cancelinsert.php?id='.$row["cust_id"].'" onclick="return checkdelete()">  <button style="background-color:F8F8FF;"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button></a></td>';
