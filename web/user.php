...
?>
	...
	<br>
		...
		<div class="container">
			 ...
			 <br>
			 <div class="panel panel-default" style="background-color:#F8F8FF; border-color:#2F4F4F; border-width:4px;">
  <div class="panel-body" style="background-color:#F8F8FF;" >
    <!--<h1 class="panel-title" style=" color:#2F4F4F;" size="100"><b>Categories of Car</b></h1>-->
  </div>
...
$con=mysql_connect('localhost','root','');
mysql_select_db('bapa',$con);
$res=mysql_query("select p.*,c.*  from car_table as c,car_type_table as p where c.fk_type_id=p.type_id",$con);
while($row=mysql_fetch_assoc($res))
{
