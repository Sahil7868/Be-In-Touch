...
function carousel() {
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="ac.php" style="color:#2F4F4F;">Show Only Ac Buses </a>
    </div>
...
$res=mysql_query("select p.*,c.*,d.* from bus_table as p , facility_table as c , driver_table as d where p.fk_facility_id=c.facility_id and p.fk_driver_id=d.driver_id and c.facility_name='Non-Ac' ",$con);
